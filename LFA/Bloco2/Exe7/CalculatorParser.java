...
public class CalculatorParser extends Parser {
	...
	public static final int
		...
		Number=10, NEWLINE=11, WS=12, COMMENT=13;
	public static final int
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << T__3) | (1L << T__4) | (1L << ID) | (1L << Number) | (1L << NEWLINE))) != 0)) {
				{
				{
				setState(8);
				stat();
	...
	public final StatContext stat() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << T__3) | (1L << T__4) | (1L << ID) | (1L << Number))) != 0)) {
					{
					setState(16);
					expr(0);
					}
	...
	public static class ExprSignalContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterExprSignal(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitExprSignal(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitExprSignal(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case T__4:
				...
				_prevctx = _localctx;
				setState(35);
				((ExprSignalContext)_localctx).op = _input.LT(1);
				_la = _input.LA(1);
				if ( !(_la==T__3 || _la==T__4) ) {
					((ExprSignalContext)_localctx).op = (Token)_errHandler.recoverInline(this);
				}
				else {
	...
	public static final String _serializedATN =
		...
		"\5\65\13\5\3\5\2\3\b\6\2\4\6\b\2\4\3\2\6\7\3\2\b\n\2;\2\r\3\2\2\2\4\32"+
		...
		"\36\7\3\2\2\36\37\5\b\5\2\37\7\3\2\2\2 !\b\5\1\2!\"\7\4\2\2\"#\5\b\5\2"+
		"#$\7\5\2\2$*\3\2\2\2%&\t\2\2\2&*\5\b\5\7\'*\7\13\2\2(*\7\f\2\2) \3\2\2"+
		"\2)%\3\2\2\2)\'\3\2\2\2)(\3\2\2\2*\63\3\2\2\2+,\f\6\2\2,-\t\3\2\2-\62"+
		"\5\b\5\7./\f\5\2\2/\60\t\2\2\2\60\62\5\b\5\6\61+\3\2\2\2\61.\3\2\2\2\62"+
