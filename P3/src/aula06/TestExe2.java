...
public class TestExe2 {
	public static void main(String[] args) {
		...
		lista2.add(new Estudante("Andreia", 9855678, new Date(18, 7, 1974)));
		lista2.add(new Estudante("Monica", 75266454, new Date(11, 8, 1978)));
		lista2.add(new Estudante("Jose", 85265426, new Date(15, 2, 1976)));
