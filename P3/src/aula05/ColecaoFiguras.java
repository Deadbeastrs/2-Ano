...
public class ColecaoFiguras implements Cloneable {
	...
	@Override
	protected ColecaoFiguras clone() throws CloneNotSupportedException {
		ColecaoFiguras temp = (ColecaoFiguras) super.clone();
		return temp;
